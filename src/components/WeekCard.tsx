...
import { FaChevronDown, FaChevronUp, FaEdit, FaTrash, FaPlus, FaMagic, FaCheckCircle, FaCalendarAlt, FaFileAlt, FaPaperPlane } from 'react-icons/fa';
        ...
        <div className="p-4 bg-gray-50/50">
            ...
            <div className="mt-6 pt-4 border-t flex justify-between items-center flex-wrap gap-2">
                <div className="flex items-center gap-2">
                    {getActionButtons()}
                    {isAuditor && (
                         <button onClick={onGenerateReport} className="btn-secondary bg-purple-600 text-white hover:bg-purple-700 flex items-center gap-2"><FaMagic/> Отчет по этапу</button>
                    )}
                </div>
