...
const AddSubTaskModal: React.FC<AddSubTaskModalProps> = ({ isOpen, onClose, onAddSubTask, contacts, project, onContactsUpdate }) => {
    ...
    return (
      <>
        <Modal isOpen={isOpen} onClose={onClose} title="Добавить подзадачу">
            {step === 'select' ? (
