...
interface AddSubTaskModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAddTask: (task: PlanItem, date?: string) => void;
  parentTask?: PlanItem;
...
const AddSubTaskModal: React.FC<AddSubTaskModalProps> = ({ isOpen, onClose, onAddTask, parentTask, contacts, project, onContactsUpdate, profile, providerToken, initialDate }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    onAddTask(newItem, useDate ? date : undefined);
    setLoading(false);
    handleClose();
  };
